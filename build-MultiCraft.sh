...
srcRepo="`pwd`/MultiCraft"
if [ ! -d "$srcRepo" ]; then
    srcRepo="$GIT_REPOS_DIR/MultiCraft"
...
usage() {
    ...
    echo "  $0 --install"
    echo
    echo "If you want to install an existing binary version,"
    echo "Run this script from a directory that contains a"
    echo "MultiCraft directory (If you want to use this location,"
    echo "'$srcRepo' would have to exist)."
    echo
}
...
if [ "@$CLEAN" = "@true" ]; then
    echo "WARNING: --clean is not implemented. See"
